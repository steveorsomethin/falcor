...
module.exports = function getRequestCycle(getResponse, model, results, observer,
    ...
    var currentRequestDisposable = requestQueue.
        get(boundRequestedMissingPaths, optimizedMissingPaths, function(err, data, replacedPaths) {
            ...
            var nextRequestedMissingPaths = replacedPaths.length ? getResponse.currentRemainingPaths : requestedMissingPaths;
            var nextValues = replacedPaths.length ? [{}] : results.values;
